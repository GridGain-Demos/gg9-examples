 ...
 * with the {@link RecordView} and user-defined POJOs.
 *
...
public class RecordViewPojoDataStreamerExample {
    ...
    /**
     * Streams {@link RecordViewPojoDataStreamerExample#ACCOUNTS_COUNT} accounts using provided table view.
     *
     * @param view The table view.
     * @param client The client.
     * @param remove If true the {@link DataStreamerOperationType#REMOVE} operation will be performed.
     */
    private static void streamAccountData(RecordView<Account> view, IgniteClient client, boolean remove) {
        //--------------------------------------------------------------------------------------
        //
        // Creating publisher.
        //
        ...
        try (var publisher = new SubmissionPublisher<DataStreamerItem<Account>>()) {
            ...
            for (int i = 0; i < ACCOUNTS_COUNT; i++) {
                Account entry = remove
                        ? new Account(i)
                        : new Account(i, "name" + i, rnd.nextLong(100_000), rnd.nextBoolean());
        ...
        //--------------------------------------------------------------------------------------
        //
        // Waiting for the data to be flushed.
        //
        //--------------------------------------------------------------------------------------
